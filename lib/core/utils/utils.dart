...
import 'package:matlop_provider/core/component/sharred_divider.dart';
...
class Utils {
  ...
  static String convertNumberToArabic(String input) {
  ...
  static void copyToClipboard(String copyValue) {
