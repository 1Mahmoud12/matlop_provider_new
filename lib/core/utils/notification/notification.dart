...
import 'package:matlop_provider/core/utils/device_id.dart';
import 'package:matlop_provider/feature/home/data/dataSource/main_data_source.dart';
import 'package:matlop_provider/feature/home/data/models/firebase_params.dart';
...
class NotificationUtility {
  ...
  static Future<void> onBackgroundMessage(RemoteMessage remoteMessage) async {
    ...
    final String title = (arabicLanguage ? remoteMessage.data['titleAr'] : remoteMessage.data['titleEn']) ?? 'notification title';
    final String body = (arabicLanguage ? remoteMessage.data['bodyAr'] : remoteMessage.data['bodyEn']) ?? 'notification body';
...
/*  static Future<void> foregroundMessageListener(
  ...
  static Future<void> createLocalNotification({
    ...
    final String title = (arabicLanguage ? message.data['titleAr'] : message.data['titleEn']) ?? 'notification title';
    final String body = (arabicLanguage ? message.data['bodyAr'] : message.data['bodyEn']) ?? 'notification body';
...
//     'message': {
//       'token':
//           'enkZrlbVQiGqCV2Nh9XXYX:APA91bGkNsoUQowuQxpfJB-PgnB3kyjMQRqNHgx87-btED62bx2tKDWq-RukHmPLDfq01h2ZKgQ_n7_tMX62WzIjW9NeD1I8t7JRUf-Ytomjm0T6hkbnM39L59WvuwKvwOfsWUZ1DNTY',
//       'notification': {
//         'body': 'to_client',
//         'title': 'notification',
